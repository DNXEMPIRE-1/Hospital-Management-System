...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> BO-Global Hospitals</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> BO-Global Hospital </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-dash-list" data-toggle="list" href="#list-prof" role="list" aria-controls="home">Profile</a>
      ...
      <a class="list-group-item list-group-item-action" id="" data-toggle="" href="gluco.php" >Glucometer Device</a>
      <a class="list-group-item list-group-item-action" id="list-home-list1" data-toggle="list" href="#list-home1" role="tab" aria-controls="home">Glucometer Recording</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-home1" onclick="clickDiv('#list-home-list1')">
                          Start Recording
                        </a>
                      </p>
                    </div>
      ...
      <div class="tab-pane fade" id="list-home1" role="tabpanel" aria-labelledby="list-home-lis1">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Start Recording</h4></center><br>
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4"><label>Recording Date</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>
                  <div class="col-md-4"><label>Reading Value</label></div>
                  <div class="col-md-8"><input type="int" class="input" name="value"></div><br><br>
                  <div class="col-md-4"><label>Recording Time</label></div>
                  <div class="col-md-8">
                    <!-- <input type="time" class="form-control" name="apptime"> -->
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      <option value="" disabled selected>Select Time</option>
                  ...
                  <input type="submit" name="app-submit" value="Create new Record" class="btn btn-primary" id="inputbtn">
