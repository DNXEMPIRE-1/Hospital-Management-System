...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-glu" id="list-press-glu" role="tab" data-toggle="list" aria-controls="home">Glucometer Records</a>
    </div><br>
  </div>
  <div class="col-md-8" style="margin-top: 3%;">
               ...
               <div class="col-sm-4" style="left: 10%">
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;"> View Glucometer Reading</h4>
                      <script>
                        function clickDiv(id) {
                          document.querySelector(id).click();
                        }
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-glu" onclick="clickDiv('#list-press-glu')">
                          Glucometer Record List 
                        </a>
                      </p>
                    </div>
                  </div>
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
      ...
      <div class="tab-pane fade" id="list-glu" role="tabpanel" aria-labelledby="list-home-list">
        ...
        <table class="table table-hover">
          <thead>
            <tr>
              ...
              <th scope="col">Appointment Date</th>
              <th scope="col">Appointment Time</th>
              <th scope="col">Glucometer Reading</th>
              <th scope="col">Current Status</th>
              <th scope="col">Action</th>
              <th scope="col">Prescribe</th>
          ...
          <tbody>
            <?php 
              ...
              global $con;
              $dname = $_SESSION['dname'];
              $query = "select pid,ID,fname,lname,gender,email,contact,appdate,apptime,glucometer,userStatus,doctorStatus from appointmenttb where doctor='$dname';";
              $result = mysqli_query($con,$query);
              while ($row = mysqli_fetch_array($result)){
                ?>
                <tr>
